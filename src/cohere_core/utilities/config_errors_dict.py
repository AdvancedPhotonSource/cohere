...
config_prep_error = {'File':['No configuration file',
                             ...
                             'Parsing error, check parenthesis,quotation syntax'],
                     'Excludescans':['exclude_scans should be a list'],
                     'MinFiles':['min_frames should be int',
                                 'min_frames parameter parsing error'],
                     'Maxcrop':['max_crop should be a list',
                                'max_crop parameter must have two values to crop 2D frame'],
                     }
config_data_error = {'File':['No configuration file',
                     ...
                     'CropPad':['crop_pad should be a list of int'],
                     'Shift':['shift should be a list of int'],
...
config_rec_error = {'File':['No configuration file',
                    ...
                    'Device':['device should be a list of ints, or string "all", or dictionary for cluster configuration',
                    ...
                    'Phasesupporttrigger':['Trigger should be a list of int',
                                           'Each sub-trigger should be a list of int if multiple phase constrain'],
                    'Phcphasemin':['phc_phase_min should be float',
                                   'phc_phase_min should be a list of floats if multiple phase constrain'],
                    'Phcphasemax':['phc_phase_max should be float',
                                   'phc_phase_max should be a list of floats if multiple phase constrain'],
                    ...
                    'Lpftrigger':['Trigger should be a list of int',
                                  'lawpass_filter_trigger should have upper limit',
                                  'Each sub-trigger should be a list of int if multiple lowpass filters'],
                    'Lowpassfilterswthreshold':['lpf_sw_threshold parameter should be float',
                    ...
                    'Lowpassfilterrange':['lowpass_filter_range parameter should be list of flots',
                                          'lowpass_filter_range should be a list of floats for each lowpass filter if multiple lowpass filters'
