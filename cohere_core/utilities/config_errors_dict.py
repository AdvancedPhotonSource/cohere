...
config_rec_error = {'File':['No configuration file',
                    ...
                    'Shrinkwrapthreshold':['sw_threshold should be float',
                                           'sw_threshold parameter parsing error'],
                    'Shrinkwrapgausssigma':['sw_gauss_sigma should be float',
                                            'sw_gauss_sigma parameter parsing error'],
                    ...
                    'Lowpassfilterswsigmarange':['lpf_sw_sigma_range parameter should be list of flots'],
                    'Lowpassfilterrange':['lpf_range parameter should be list of flots'],
